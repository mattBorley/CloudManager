...
try:
    from app.routers.clouds import router as cloudsRouter
except ImportError:
    from routers.clouds import router as cloudsRouter
app = FastAPI()
...
app.include_router(cloudsRouter, prefix="/api/cloud", tags=["cloud"])
