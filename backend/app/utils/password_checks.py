...
password_criteria = [
    ...
    },
    {
        ...
        "test": lambda password: any(c.isupper() for c in password),
    },
    {
        "id": 3,
        "rule": "At least one lowercase letter",
        "test": lambda password: any(c.islower() for c in password),
    },
    {
        "id": 4,
        "rule": "At least one number",
        "test": lambda password: any(c.isdigit() for c in password),
    },
    {
        "id": 5,
        "rule": "At least one special character",
        "test": lambda password: any(c in '!@#$%^&*(),.?":{}|<>' for c in password),
    },
]
